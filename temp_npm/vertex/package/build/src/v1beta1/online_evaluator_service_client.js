...
exports.OnlineEvaluatorServiceClient = void 0;
 ...
 */
const gapicConfig = require("./online_evaluator_service_client_config.json");
...
class OnlineEvaluatorServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            onlineEvaluatorPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/onlineEvaluators/{online_evaluator}'),
            ...
            reasoningEngineRuntimeRevisionPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/reasoningEngines/{reasoning_engine}/runtimeRevisions/{runtime_revision}'),
        ...
        this.descriptors.page = {
            listOnlineEvaluators: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'onlineEvaluators')
        };
        ...
        const createOnlineEvaluatorResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.OnlineEvaluator');
        const createOnlineEvaluatorMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateOnlineEvaluatorOperationMetadata');
        const updateOnlineEvaluatorResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.OnlineEvaluator');
        const updateOnlineEvaluatorMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateOnlineEvaluatorOperationMetadata');
        const deleteOnlineEvaluatorResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteOnlineEvaluatorMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOnlineEvaluatorOperationMetadata');
        const activateOnlineEvaluatorResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.OnlineEvaluator');
        const activateOnlineEvaluatorMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ActivateOnlineEvaluatorOperationMetadata');
        const suspendOnlineEvaluatorResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.OnlineEvaluator');
        const suspendOnlineEvaluatorMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.SuspendOnlineEvaluatorOperationMetadata');
        this.descriptors.longrunning = {
            createOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createOnlineEvaluatorResponse.decode.bind(createOnlineEvaluatorResponse), createOnlineEvaluatorMetadata.decode.bind(createOnlineEvaluatorMetadata)),
            updateOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateOnlineEvaluatorResponse.decode.bind(updateOnlineEvaluatorResponse), updateOnlineEvaluatorMetadata.decode.bind(updateOnlineEvaluatorMetadata)),
            deleteOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteOnlineEvaluatorResponse.decode.bind(deleteOnlineEvaluatorResponse), deleteOnlineEvaluatorMetadata.decode.bind(deleteOnlineEvaluatorMetadata)),
            activateOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(this.operationsClient, activateOnlineEvaluatorResponse.decode.bind(activateOnlineEvaluatorResponse), activateOnlineEvaluatorMetadata.decode.bind(activateOnlineEvaluatorMetadata)),
            suspendOnlineEvaluator: new this._gaxModule.LongrunningDescriptor(this.operationsClient, suspendOnlineEvaluatorResponse.decode.bind(suspendOnlineEvaluatorResponse), suspendOnlineEvaluatorMetadata.decode.bind(suspendOnlineEvaluatorMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.OnlineEvaluatorService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.onlineEvaluatorServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.aiplatform.v1beta1.OnlineEvaluatorService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.aiplatform.v1beta1.OnlineEvaluatorService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const onlineEvaluatorServiceStubMethods = ['createOnlineEvaluator', 'getOnlineEvaluator', 'updateOnlineEvaluator', 'deleteOnlineEvaluator', 'listOnlineEvaluators', 'activateOnlineEvaluator', 'suspendOnlineEvaluator'];
        for (const methodName of onlineEvaluatorServiceStubMethods) {
            const callPromise = this.onlineEvaluatorServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getOnlineEvaluator(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    createOnlineEvaluator(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateOnlineEvaluatorProgress(name) {
    ...
    updateOnlineEvaluator(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkUpdateOnlineEvaluatorProgress(name) {
    ...
    deleteOnlineEvaluator(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeleteOnlineEvaluatorProgress(name) {
    ...
    activateOnlineEvaluator(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkActivateOnlineEvaluatorProgress(name) {
    ...
    suspendOnlineEvaluator(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkSuspendOnlineEvaluatorProgress(name) {
    ...
    listOnlineEvaluators(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listOnlineEvaluatorsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listOnlineEvaluators.createStream(this.innerApiCalls.listOnlineEvaluators, request, callSettings);
    }
    /**
     ...
     */
    listOnlineEvaluatorsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listOnlineEvaluators.asyncIterate(this.innerApiCalls['listOnlineEvaluators'], request, callSettings);
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    onlineEvaluatorPath(project, location, onlineEvaluator) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromOnlineEvaluatorName(onlineEvaluatorName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromOnlineEvaluatorName(onlineEvaluatorName) {
     ...
     */
    matchOnlineEvaluatorFromOnlineEvaluatorName(onlineEvaluatorName) {
     ...
     * @returns {string} Resource name string.
     */
    reasoningEngineRuntimeRevisionPath(project, location, reasoningEngine, runtimeRevision) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromReasoningEngineRuntimeRevisionName(reasoningEngineRuntimeRevisionName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromReasoningEngineRuntimeRevisionName(reasoningEngineRuntimeRevisionName) {
     ...
     * @returns {string} A string representing the reasoning_engine.
     */
    matchReasoningEngineFromReasoningEngineRuntimeRevisionName(reasoningEngineRuntimeRevisionName) {
     ...
     */
    matchRuntimeRevisionFromReasoningEngineRuntimeRevisionName(reasoningEngineRuntimeRevisionName) {
...
exports.OnlineEvaluatorServiceClient = OnlineEvaluatorServiceClient;
//# sourceMappingURL=online_evaluator_service_client.js.map