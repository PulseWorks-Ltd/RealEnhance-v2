...
class EvaluationServiceClient {
    ...
    initialize() {
        ...
        const evaluationServiceStubMethods = ['evaluateInstances', 'evaluateDataset', 'generateInstanceRubrics'];
    ...
    generateInstanceRubrics(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
