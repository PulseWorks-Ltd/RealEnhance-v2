...
exports.ReasoningEngineRuntimeRevisionServiceClient = void 0;
 ...
 */
const gapicConfig = require("./reasoning_engine_runtime_revision_service_client_config.json");
...
class ReasoningEngineRuntimeRevisionServiceClient {
    ...
    pathTemplates;
    operationsClient;
    reasoningEngineRuntimeRevisionServiceStub;
    /**
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listReasoningEngineRuntimeRevisions: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'reasoningEngineRuntimeRevisions')
        };
        ...
        const deleteReasoningEngineRuntimeRevisionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteReasoningEngineRuntimeRevisionMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteReasoningEngineRuntimeRevisionOperationMetadata');
        this.descriptors.longrunning = {
            deleteReasoningEngineRuntimeRevision: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteReasoningEngineRuntimeRevisionResponse.decode.bind(deleteReasoningEngineRuntimeRevisionResponse), deleteReasoningEngineRuntimeRevisionMetadata.decode.bind(deleteReasoningEngineRuntimeRevisionMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.reasoningEngineRuntimeRevisionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.aiplatform.v1beta1.ReasoningEngineRuntimeRevisionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const reasoningEngineRuntimeRevisionServiceStubMethods = ['getReasoningEngineRuntimeRevision', 'listReasoningEngineRuntimeRevisions', 'deleteReasoningEngineRuntimeRevision'];
        for (const methodName of reasoningEngineRuntimeRevisionServiceStubMethods) {
            const callPromise = this.reasoningEngineRuntimeRevisionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getReasoningEngineRuntimeRevision(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    deleteReasoningEngineRuntimeRevision(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkDeleteReasoningEngineRuntimeRevisionProgress(name) {
    ...
    listReasoningEngineRuntimeRevisions(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listReasoningEngineRuntimeRevisionsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listReasoningEngineRuntimeRevisions.createStream(this.innerApiCalls.listReasoningEngineRuntimeRevisions, request, callSettings);
    }
    /**
     ...
     */
    listReasoningEngineRuntimeRevisionsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listReasoningEngineRuntimeRevisions.asyncIterate(this.innerApiCalls['listReasoningEngineRuntimeRevisions'], request, callSettings);
    }
    /**
...
exports.ReasoningEngineRuntimeRevisionServiceClient = ReasoningEngineRuntimeRevisionServiceClient;
//# sourceMappingURL=reasoning_engine_runtime_revision_service_client.js.map