...
class ReasoningEngineExecutionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const asyncQueryReasoningEngineResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.AsyncQueryReasoningEngineResponse');
        const asyncQueryReasoningEngineMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.AsyncQueryReasoningEngineOperationMetadata');
        this.descriptors.longrunning = {
            asyncQueryReasoningEngine: new this._gaxModule.LongrunningDescriptor(this.operationsClient, asyncQueryReasoningEngineResponse.decode.bind(asyncQueryReasoningEngineResponse), asyncQueryReasoningEngineMetadata.decode.bind(asyncQueryReasoningEngineMetadata))
        };
    ...
    initialize() {
        ...
        const reasoningEngineExecutionServiceStubMethods = ['queryReasoningEngine', 'streamQueryReasoningEngine', 'asyncQueryReasoningEngine', 'cancelAsyncQueryReasoningEngine'];
    ...
    cancelAsyncQueryReasoningEngine(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    asyncQueryReasoningEngine(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkAsyncQueryReasoningEngineProgress(name) {
