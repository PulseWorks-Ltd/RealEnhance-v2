...
class ReasoningEngineExecutionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const asyncQueryReasoningEngineResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.AsyncQueryReasoningEngineResponse');
        const asyncQueryReasoningEngineMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1.AsyncQueryReasoningEngineOperationMetadata');
