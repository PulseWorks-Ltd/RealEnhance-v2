...
export default function Login() {
  ...
  const { signInWithEmail, ensureSignedIn } = useAuth();
  ...
  const emailHasError = submitted && !emailValid;
  const passwordHasError = submitted && !passwordValid;
    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-50">
      <div className="hidden md:block md:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 p-10 space-y-3 text-white max-w-xl">
          <img src="/Logo-dark-v2.png" alt="RealEnhance" className="h-10 w-auto drop-shadow" />
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-10 md:p-12 bg-white">
        <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-right-2 duration-300">
          <div className="space-y-3">
            <img src="/Logo-light-v2.png" alt="RealEnhance" className="h-9 w-auto" />
            <div className="space-y-1">
              ...
              <form onSubmit={handleEmailSubmit} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    disabled={loading}
                    className={inputTone(emailHasError, emailValid)}
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    minLength={8}
                    disabled={loading}
                    className={inputTone(passwordHasError, passwordValid)}
