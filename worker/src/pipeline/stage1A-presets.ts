...
export const AblationPresets: Record<string, AblationSettings> = {
  ...
  "interior-open-ambient": {
    ...
    STAGE1A_PREGEN_TONE_STACK_SCALE: 0.55,
    STAGE1A_PREGEN_LOCAL_CONTRAST_SCALE: 0.6,
    ...
    STAGE1A_PREGEN_SHADOW_OFFSET_SCALE: 0.35,
    STAGE1A_PREGEN_MODULATE_SCALE: 1.1,
  ...
  "exterior-nz-hero": {
    ...
    STAGE1A_PREGEN_LOCAL_CONTRAST_SCALE: 0.72,
    STAGE1A_PREGEN_MEDIAN_ENABLED: false,
    STAGE1A_ENABLE_POSTGEN_FINISH: true,
    PREPROCESS_CANONICAL_HIGH_FIDELITY: true,
    ...
    STAGE1A_PREGEN_SHADOW_OFFSET_SCALE: 0.55,
