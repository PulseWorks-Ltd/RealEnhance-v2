...
────────────────────────────────
CAMERA & VIEWPOINT HARD LOCK — MASTER BLOCK
────────────────────────────────

Camera framing, viewpoint, and scale are LOCKED.
...
• Keep camera angle, framing, lens perspective, and vanishing geometry exactly as provided by Stage 1B
...
────────────────────────────────
STRUCTURE & BUILT-INS HARD LOCK — MASTER BLOCK
────────────────────────────────
...
Authority hierarchy:
user intent > model interpretation > layout heuristics
...
────────────────────────────────
KITCHEN & ISLAND STAGING RESTRICTIONS
────────────────────────────────
...
- ${isFullStaging ? 'No island/counter seating additions.' : 'Existing island/counter seating only (refresh mode): may be visually refreshed but must keep existing count and placement.'}
- ${isFullStaging ? 'Do not add bar stools, counter stools, high chairs, or new island seating positions.' : 'No new bar stools, counter stools, high chairs, or new island seating positions.'}
...
────────────────────────────────
IMAGE BOUNDARY & WALL VISIBILITY RULES
────────────────────────────────
